 ...
 *
 * Inside the app layout like every other real page, unlike
 * `/create-organization`, which is a gate the console sends people to and so
 * sits outside it.
 *
...
function OnboardingRoute() {
  ...
  const { mayInvite } = useMemberActionScope();
