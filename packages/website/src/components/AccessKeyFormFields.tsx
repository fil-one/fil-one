  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <FormField
        ...
        error={granularPermissions.length === 0 ? 'Select at least one permission.' : undefined}
      >
        <AccessKeyPermissionsFields value={granularPermissions} onChange={setGranularPermissions} />
      </FormField>
