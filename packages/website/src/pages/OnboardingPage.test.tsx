...
describe('OnboardingPage', () => {
  ...
  it('offers the explore-more paths as their own next steps', () => {
    render(<OnboardingPage mayInvite />);
  ...
  it('leaves out Invite your team for a caller who may not invite', () => {
    // `POST /api/org/invitations` still refuses an org outside the beta, so
    // the card would only lead to a form the server turns down.
    render(<OnboardingPage mayInvite={false} />);
