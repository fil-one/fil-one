  ...
  return (
    <AddOnDisabledPage
      ...
      enableCard={{
        ...
        subline:
          'Fil One charges a flat fee per TB stored with indexing enabled. Your LLM provider costs are separate.',
        inclusions: [
        ...
        notIncludedNote:
          'LLM and embedding costs are billed directly by your provider and are not part of your Fil One invoice.',
      }}
      onEnable={onEnable}
    />
  );
      ...
      <div className="max-w-2xl space-y-12">
        <div className="flex items-start justify-between">
          <Heading
            tag="h1"
            size="2xl"
            description="Indexing is active. Your buckets are queryable via the API."
          >
...
export function RagPipelinePage() {
  ...
  if (state === 'active')
    return <RagPipelineLiveView onDisable={() => setStatus('/rag-pipeline', 'disabled')} />;
  if (state === 'disabled')
    return <RagPipelineDisabledView onEnable={() => setStatus('/rag-pipeline', 'active')} />;
