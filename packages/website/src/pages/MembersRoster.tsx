...
import { MemberDialogs, useMemberDialogs } from './MembersRosterDialogs.js';
import type { RoleChange } from './MembersRosterDialogs.js';
...
export function MembersRoster() {
  ...
  function handleRoleChange(member: MemberSummary, role: OrgRole) {
    ...
    // A narrowing revokes keys the member could no longer mint under the new
    // role, with no other warning — so it is confirmed with a preview of what
    // goes, the same as promoting or removing somebody.
