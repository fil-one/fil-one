...
TEST RUN
  ...
  Raw JSON  : ../logs/20260707_181732_compatibility_pytest_main.json, ../logs/20260707_181732_compatibility_pytest_quarantine.json
```
...
**Error stack trace** — `list_objects_v2` — `failed` — 7.432s
...
**Error stack trace** — `list_objects_v2` — `failed` — 1.358s
...
**Error stack trace** — `s3_core` — `failed` — 1.178s
...
**Error stack trace** — `s3_core` — `failed` — 1.177s
...
**Error stack trace** — `list_objects_v2` — `failed` — 1.193s
...
**Error stack trace** — `s3_core` — `failed` — 1.231s
...
**Error stack trace** — `list_objects_v2` — `failed` — 1.267s
...
**Error stack trace** — `s3_core` — `failed` — 439.512s
...
**Error stack trace** — `s3_core` — `failed` — 2.111s
...
**Error stack trace** — `s3_core` — `failed` — 3.58s
...
**Error stack trace** — `s3_core` — `failed` — 8.019s
...
**Error stack trace** — `s3_core` — `failed` — 1.523s
...
**Error stack trace** — `s3_core` — `failed` — 2.931s
...
**Error stack trace** — `s3_core` — `failed` — 1.878s
...
**Error stack trace** — `s3_core` — `failed` — 2.702s
...
**Error stack trace** — `s3_core` — `failed` — 3.114s
...
**Error stack trace** — `s3_core` — `failed` — 10.704s
...
**Error stack trace** — `s3_core` — `failed` — 6.329s
...
**Error stack trace** — `s3_core` — `failed` — 14.72s
...
**Error stack trace** — `s3_core` — `failed` — 11.856s
...
**Error stack trace** — `s3_core` — `failed` — 9.224s
...
**Error stack trace** — `s3_core` — `failed` — 19.282s
...
**Error stack trace** — `s3_core` — `failed` — 6.396s
...
**Error stack trace** — `s3_core` — `failed` — 12.262s
...
**Error stack trace** — `s3_core` — `failed` — 9.056s
...
**Error stack trace** — `s3_core` — `failed` — 12.206s
...
**Error stack trace** — `s3_core` — `failed` — 13.059s
...
**Error stack trace** — `s3_core` — `failed` — 5.696s
...
**Error stack trace** — `s3_core` — `failed` — 11.98s
...
**Error stack trace** — `s3_core` — `failed` — 11.991s
...
**Error stack trace** — `s3_core` — `failed` — 11.062s
...
**Error stack trace** — `s3_core` — `failed` — 14.654s
...
**Error stack trace** — `s3_core` — `failed` — 15.674s
...
**Error stack trace** — `s3_core` — `failed` — 16.925s
...
**Error stack trace** — `s3_core` — `failed` — 9.078s
...
**Error stack trace** — `s3_core` — `failed` — 8.173s
...
**Error stack trace** — `s3_core` — `failed` — 8.583s
...
**Error stack trace** — `s3_core` — `failed` — 13.702s
...
**Error stack trace** — `s3_core` — `failed` — 1.274s
...
**Error stack trace** — `s3_core` — `failed` — 1.425s
...
**Error stack trace** — `s3_core` — `failed` — 1.209s
...
**Error stack trace** — `s3_core` — `failed` — 1.296s
...
**Error stack trace** — `s3_core` — `failed` — 1.335s
...
**Error stack trace** — `s3_core` — `failed` — 2.719s
...
**Error stack trace** — `s3_core` — `failed` — 2.417s
...
**Error stack trace** — `s3_core` — `failed` — 2.182s
...
**Error stack trace** — `s3_core` — `failed` — 4.607s
...
**Error stack trace** — `s3_core` — `failed` — 2.868s
...
**Error stack trace** — `s3_core` — `failed` — 2.004s
...
**Error stack trace** — `s3_core` — `failed` — 4.265s
...
**Error stack trace** — `s3_core` — `failed` — 3.994s
...
**Error stack trace** — `s3_core` — `failed` — 1.193s
...
**Error stack trace** — `s3_core` — `failed` — 1.226s
...
**Error stack trace** — `s3_core` — `failed` — 1.86s
...
**Error stack trace** — `list_objects_v2` — `failed` — 1.992s
...
**Error stack trace** — `s3_core` — `failed` — 1.794s
...
**Error stack trace** — `list_objects_v2` — `failed` — 2.271s
...
**Error stack trace** — `s3_core` — `failed` — 2.363s
...
**Error stack trace** — `list_objects_v2` — `failed` — 1.777s
...
**Error stack trace** — `s3_core` — `failed` — 1.646s
...
**Error stack trace** — `s3_core` — `failed` — 3.801s
...
**Error stack trace** — `s3_core` — `failed` — 1.838s
...
**Error stack trace** — `s3_core` — `failed` — 2.019s
...
**Error stack trace** — `s3_core` — `failed` — 1.533s
...
**Error stack trace** — `s3_core` — `failed` — 1.577s
...
**Error stack trace** — `s3_core` — `failed` — 1.168s
...
**Error stack trace** — `copy` — `failed` — 8.314s
...
**Error stack trace** — `copy` — `failed` — 14.965s
...
**Error stack trace** — `copy` — `failed` — 3.1s
...
**Error stack trace** — `copy` — `failed` — 2.672s
...
**Error stack trace** — `copy` — `failed` — 1.398s
...
**Error stack trace** — `copy` — `failed` — 32.478s
...
**Error stack trace** — `s3_core` — `failed` — 28.069s
...
**Error stack trace** — `copy` — `failed` — 2.216s
...
**Error stack trace** — `s3_core` — `failed` — 9.757s
...
**Error stack trace** — `s3_core` — `failed` — 5.659s
...
**Error stack trace** — `s3_core` — `failed` — 1.216s
...
**Error stack trace** — `s3_core` — `failed` — 1.248s
...
**Error stack trace** — `s3_core` — `failed` — 1.278s
...
**Error stack trace** — `s3_core` — `failed` — 8.784s
...
**Error stack trace** — `s3_core` — `failed` — 12.541s
...
**Error stack trace** — `s3_core` — `failed` — 0.779s
...
**Error stack trace** — `s3_core` — `failed` — 0.733s
...
**Error stack trace** — `s3_core` — `failed` — 13.365s
...
**Error stack trace** — `s3_core` — `failed` — 8.567s
...
**Error stack trace** — `s3_core` — `failed` — 0.697s
...
**Error stack trace** — `s3_core` — `failed` — 0.742s
...
**Error stack trace** — `s3_core` — `failed` — 13.321s
...
**Error stack trace** — `s3_core` — `failed` — 11.311s
...
**Error stack trace** — `tagging` — `failed` — 1.679s
...
**Error stack trace** — `s3_core` — `failed` — 10.676s
...
**Error stack trace** — `s3_core` — `failed` — 11.451s
...
**Error stack trace** — `s3_core` — `failed` — 10.006s
...
**Error stack trace** — `s3_core` — `failed` — 3.885s
...
**Error stack trace** — `s3_core` — `failed` — 14.938s
...
**Error stack trace** — `s3_core` — `failed` — 25.434s
...
**Error stack trace** — `s3_core` — `failed` — 6.701s
...
**Error stack trace** — `s3_core` — `failed` — 7.085s
...
**Error stack trace** — `lifecycle` — `failed` — 2.601s
...
**Error stack trace** — `lifecycle` — `failed` — 1.289s
...
**Error stack trace** — `lifecycle` — `failed` — 1.491s
...
**Error stack trace** — `lifecycle_expiration` — `failed` — 2.285s
...
**Error stack trace** — `lifecycle_expiration` — `failed` — 2.582s
...
**Error stack trace** — `encryption` — `failed` — 1.717s
...
**Error stack trace** — `encryption` — `failed` — 1.505s
...
**Error stack trace** — `encryption` — `failed` — 1.858s
...
**Error stack trace** — `encryption` — `failed` — 1.745s
...
**Error stack trace** — `encryption` — `failed` — 1.536s
...
**Error stack trace** — `encryption` — `failed` — 1.633s
...
**Error stack trace** — `encryption` — `failed` — 1.754s
...
**Error stack trace** — `encryption` — `failed` — 10.591s
...
**Error stack trace** — `encryption` — `failed` — 1.997s
...
**Error stack trace** — `bucket_policy` — `failed` — 3.071s
...
**Error stack trace** — `bucket_policy` — `failed` — 2.2s
...
**Error stack trace** — `bucket_policy` — `failed` — 2.464s
...
**Error stack trace** — `bucket_policy` — `failed` — 1.534s
...
**Error stack trace** — `bucket_policy` — `failed` — 2.097s
...
**Error stack trace** — `bucket_policy` — `failed` — 3.971s
...
**Error stack trace** — `bucket_policy` — `failed` — 3.512s
...
**Error stack trace** — `bucket_policy` — `failed` — 12.398s
...
**Error stack trace** — `bucket_policy` — `failed` — 2.021s
...
**Error stack trace** — `tagging` — `failed` — 3.606s
...
**Error stack trace** — `tagging` — `failed` — 3.653s
...
**Error stack trace** — `tagging` — `failed` — 4.224s
...
**Error stack trace** — `tagging` — `failed` — 3.228s
...
**Error stack trace** — `tagging` — `failed` — 4.456s
...
**Error stack trace** — `tagging` — `failed` — 3.253s
...
**Error stack trace** — `tagging` — `failed` — 2.965s
...
**Error stack trace** — `tagging` — `failed` — 3.616s
...
**Error stack trace** — `tagging` — `failed` — 3.609s
...
**Error stack trace** — `tagging` — `failed` — 2.328s
...
**Error stack trace** — `tagging` — `failed` — 2.587s
...
**Error stack trace** — `tagging` — `failed` — 2.389s
...
**Error stack trace** — `tagging` — `failed` — 3.631s
...
**Error stack trace** — `tagging` — `failed` — 3.759s
...
**Error stack trace** — `s3_core` — `failed` — 17.532s
...
**Error stack trace** — `tagging` — `failed` — 6.379s
...
**Error stack trace** — `tagging` — `failed` — 4.174s
...
**Error stack trace** — `tagging` — `failed` — 3.156s
...
**Error stack trace** — `tagging` — `failed` — 7.025s
...
**Error stack trace** — `tagging` — `failed` — 5.565s
...
**Error stack trace** — `bucket_policy` — `failed` — 3.58s
...
**Error stack trace** — `encryption` — `failed` — 8.493s
...
**Error stack trace** — `encryption` — `failed` — 7.034s
...
**Error stack trace** — `encryption` — `failed` — 2.076s
...
**Error stack trace** — `tagging` — `failed` — 2.65s
...
**Error stack trace** — `tagging` — `failed` — 2.52s
...
**Error stack trace** — `copy` — `failed` — 2.041s
...
**Error stack trace** — `copy` — `failed` — 2.118s
...
**Error stack trace** — `s3_core` — `failed` — 1.706s
...
**Error stack trace** — `s3_core` — `failed` — 1.504s
...
**Error stack trace** — `s3_core` — `failed` — 1.703s
...
**Error stack trace** — `s3_core` — `failed` — 1.704s
...
**Error stack trace** — `s3_core` — `failed` — 1.491s
...
**Error stack trace** — `s3_core` — `failed` — 1.384s
...
**Error stack trace** — `s3_core` — `failed` — 1.477s
...
**Error stack trace** — `s3_core` — `failed` — 1.49s
...
**Error stack trace** — `s3_core` — `failed` — 1.692s
...
**Error stack trace** — `s3_core` — `failed` — 1.781s
...
**Error stack trace** — `s3_core` — `failed` — 1.897s
...
**Error stack trace** — `s3_core` — `failed` — 15.202s
...
**Error stack trace** — `s3_core` — `failed` — 3.041s
...
**Error stack trace** — `s3_core` — `failed` — 1.47s
...
**Error stack trace** — `sse_s3` — `failed` — 1.239s
...
**Error stack trace** — `encryption` — `failed` — 1.961s
...
**Error stack trace** — `sse_s3` — `failed` — 1.796s
...
**Error stack trace** — `encryption` — `failed` — 1.877s
...
**Error stack trace** — `encryption` — `failed` — 1.692s
...
**Error stack trace** — `encryption` — `failed` — 1.566s
...
**Error stack trace** — `encryption` — `failed` — 1.859s
...
**Error stack trace** — `encryption` — `failed` — 1.696s
...
**Error stack trace** — `checksum` — `failed` — 6.012s
...
**Error stack trace** — `bucket_logging` — `failed` — 2.298s
...
**Error stack trace** — `bucket_logging` — `failed` — 3.066s
...
**Error stack trace** — `bucket_logging` — `failed` — 3.08s
...
**Error stack trace** — `bucket_logging` — `failed` — 2.17s
...
**Error stack trace** — `bucket_logging` — `failed` — 3.869s
...
**Error stack trace** — `bucket_logging` — `failed` — 2.251s
...
**Error stack trace** — `s3_core` — `failed` — 1.318s
...
**Error stack trace** — `conditional_write` — `failed` — 3.018s
...
**Error stack trace** — `conditional_write` — `failed` — 24.227s
...
**Error stack trace** — `conditional_write` — `failed` — 9.917s
...
**Error stack trace** — `conditional_write` — `failed` — 4.52s
...
**Error stack trace** — `s3_core` — `failed` — 9.612s
...
**Error stack trace** — `s3_core` — `failed` — 10.344s
...
**Error stack trace** — `s3_core` — `failed` — 12.388s
...
**Error stack trace** — `s3_core` — `failed` — 10.863s
...
**Error stack trace** — `s3_core` — `failed` — 12.572s
...
**Error stack trace** — `s3_core` — `failed` — 12.404s
...
**Error stack trace** — `s3_core` — `failed` — 1.526s
...
E    +  where 404 = _get_status({'Error': {'Code': '404', 'Message': 'Not Found'}, 'ResponseMetadata': {'HTTPHeaders': {'content-length': '9', 'conten...ode': 404, 'HostId': '1783452405477698674-9b2b8edd085c8242', 'RequestId': '1783452405477698674-9b2b8edd085c8242', ...}})
E    +    where {'Error': {'Code': '404', 'Message': 'Not Found'}, 'ResponseMetadata': {'HTTPHeaders': {'content-length': '9', 'conten...ode': 404, 'HostId': '1783452405477698674-9b2b8edd085c8242', 'RequestId': '1783452405477698674-9b2b8edd085c8242', ...}} = ClientError('An error occurred (404) when calling the HeadObject operation: Not Found').response
```
...
**Error stack trace** — `encryption` — `failed` — 3.962s
...
**Error stack trace** — `encryption` — `failed` — 4.02s
...
**Error stack trace** — `encryption` — `failed` — 1.649s
...
**Error stack trace** — `encryption` — `failed` — 1.581s
...
**Error stack trace** — `encryption` — `failed` — 2.261s
...
**Error stack trace** — `encryption` — `failed` — 3.38s
...
**Error stack trace** — `encryption` — `failed` — 6.45s
...
**Error stack trace** — `encryption` — `failed` — 4.935s
...
**Error stack trace** — `encryption` — `failed` — 3.267s
...
**Error stack trace** — `encryption` — `failed` — 4.069s
...
**Error stack trace** — `encryption` — `failed` — 3.393s
...
**Error stack trace** — `encryption` — `failed` — 3.46s
...
**Error stack trace** — `encryption` — `failed` — 4.386s
...
**Error stack trace** — `encryption` — `failed` — 1.542s
...
**Error stack trace** — `encryption` — `failed` — 2.118s
...
**Error stack trace** — `encryption` — `failed` — 1.977s
...
**Error stack trace** — `encryption` — `failed` — 1.863s
...
**Error stack trace** — `encryption` — `failed` — 1.904s
...
**Error stack trace** — `encryption` — `failed` — 1.824s
...
**Error stack trace** — `encryption` — `failed` — 10.37s
...
**Error stack trace** — `encryption` — `failed` — 1.44s
...
**Error stack trace** — `encryption` — `failed` — 2.002s
...
**Error stack trace** — `encryption` — `failed` — 2.893s
